    ...
    sections: [
      {
        ...
        title: "はじめに",
        content:
          "当社は，当社が運営するサービス「僕らのヴィンテージ」がウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，お客様の個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。",
      },
      {
        id: "collection",
        title: "第1条　個人情報の収集方法",
        content:
          "当社は，お客様が利用登録をする際に氏名，メールアドレス，その他の個人情報をお尋ねすることがあります。また，お客様と提携先などとの間でなされたお客様の個人情報を含む取引記録や決済に関する情報を,当社の提携先（情報提供元，広告主，広告配信先などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。",
      },
      {
        id: "purpose",
      ...
      },
      {
        ...
        contactInfo: ["E-mail:ourVintageApp@gmail.com"],
      },
    ],
  };
              ...
              <OrderedList color={textColor} spacing={3}>
                    ...
                    {itemIndex === 0 && (
                      <>
                        <OrderedList mt={2} ml={4}>
                          {privacyData.sections[4].subItems?.map(
                            (subItem, subIndex) => (
                              <ListItem key={subIndex} lineHeight="tall">
                                {subItem}
                                {subIndex === 3 && (
                                  <UnorderedList mt={2} ml={4}>
                                    {privacyData.sections[4].subSubItems?.map(
                ...
                {privacyData.sections[4].items2?.map((item, itemIndex) => (
                  ...
                  >
                    ...
                    {itemIndex === 0 && (
                      <OrderedList mt={2} ml={4}>
                        {privacyData.sections[4].subItems2?.map(
                          (subItem, subIndex) => (
                            <ListItem key={subIndex} lineHeight="tall">
                              {subItem}
                            </ListItem>
              ...
              <OrderedList color={textColor} spacing={3}>
                {privacyData.sections[5].items?.map((item, itemIndex) => (
                  <ListItem key={itemIndex} lineHeight="tall">
                    ...
                    {itemIndex === 0 && (
                      <OrderedList mt={2} ml={4}>
                        {privacyData.sections[5].subItems?.map(
                          (subItem, subIndex) => (
                            <ListItem key={subIndex} lineHeight="tall">
                              {subItem}
                            </ListItem>
