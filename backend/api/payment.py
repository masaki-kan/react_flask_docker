    ...
    try:
        ...
        if is_early_bird:
            ...
            return jsonify({
                ...
                'nextBillingAmount': 770 if plan_status == 0 else 7700,
                'isEarlyBird': True,
        ...
        # ========== 先着枠外: 既存ロジック ==========
        if plan_status == 0:  # 月額プラン（770円、初月無料）
            ...
            return jsonify({
                ...
                'nextBillingAmount': 770,
                'isEarlyBird': False,
            })

        else:  # 年額プラン（7700円、即時決済）
        ...
        with get_db_connection() as conn:
            ...
            try:
                ...
                return jsonify({
                    ...
                    "amount": 770 if plan_type == 0 else 7700
                })
